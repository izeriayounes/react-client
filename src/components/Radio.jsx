  ...
  return (
    <div className="mb-4 flex">
      ...
      <div className="flex-1">
        <input type="radio" id="male" name="sexe" value="masculin" className="mr-1" {...register('sexe')} />
        <label htmlFor="male" className="mr-4 text-sm">
          Masculin
        </label>

        <input type="radio" id="feminine" name="sexe" value="feminin" className="mr-1" {...register('sexe')} />
